    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/news_article_pics/tv_latestimg1.png" alt="Article hero" class="w-full rounded-lg object-cover" style="height:360px;" />
                    
                </div>
                <h1 class="text-3xl font-bold text-blue-800 mb-2">Stranger Things fans spot worrying clue beloved character will be killed off in new Netflix pics - as they fret 'the signs have always been there!'</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By JESS LESTER</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 12:51 GMT, 10 December 2025 | Updated: 15:20 GMT, 10 December 2025</div>
                </div>

                
                <p class="text-gray-700 leading-relaxed">Stranger Things fans have spotted a worrying clue that a beloved character will be killed off in the soon-to-be-released final episodes of the sci-fi hit's fifth season. <br>
                <br>Viewers were left up in arms earlier this week after noticing a missing character photo from the most recent promo for episodes that will drop on Netflix on Boxing Day and New Year's Day. <br>
                <br>The first four episodes of the fifth series made their debut on the streaming service last month - and soared to the top of the charts as fans flooded the site to watch.</p>
                <div class="my-4 border-t border-blue-300 py-2">
                    <!-- Section -->
                <section class="mt-4">
                    <p class="text-gray-700 mt-2">Show creators the Duffer Brothers have teased that the episodes that are soon to come will include one of the show's most tragic deaths to date. <br>
                        ...
                        <br>And viewers have long been speculating which of the characters will make it to the final episode of the show - with fans convinced some of the key stars will not survive.<br>
                        <br>Now, some have spotted a 'clue' as to who could be next to go, after Netflix shared a series of new images of their key characters to Instagram.</p>
                    <div class="mt-4">
                        <img src="/assets/news_article_pics/tv_latestimg2.png" alt="Military exercises 'Iron Defender' at a military range in Wierzbiny" class="w-full h-auto object-contain rounded-lg shadow" />
                    </div>
                    <p class="text-gray-700 mt-6">On the official Stranger Things Instagram account, photos of Millie Bobby Brown's Eleven, Noah Schnapp's Will, Finn Wolfhard's Mike, Gaten Matarazzo's Dustin, Caleb McLaughlin's Lucas and Sadie Sink's Max were released. <br> 
                        <br>They were joined by images of Joe Keery as Steve, Natalia Dyer as Nancy and Charlie Heaton as Jonathan, under the captions: 'Ready for one last battle.'<br>
                        <br>Many pointed out that Maya Hawke's Robin Buckley was missing from the line-up of photos, despite the character becoming key to the story since joining in series three.<br>
                        <br>Underneath the collection of nine photos posted on Instagram, fans began to speculate that it could mean Robin dies in the upcoming episodes. <br> 
                        <br>'Um, I beg your finest pardon where is my girl Robin at?' one penned, as another added: 'Max is BACK, but where is ROBIN?'<br>
                        <br>A third penned: 'Very funny, where the HELL is Robin,' as a fourth chimed in: 'The signs have always been there she isn't making out alive...'</p>
                    <div class="mt-4">
                        <img src="/assets/news_article_pics/tv_latestimg3.png" alt="Military exercises 'Iron Defender' at a military range in Wierzbiny" class="w-full h-auto object-contain rounded-lg shadow" />
                    </div>
                    <p class="text-gray-700 mt-6">Another added: 'So they just confirmed robin is gonna die,' as someone else echoed: 'I guess they gave us a hint, probably Robin.' <br> 
                        <br>It comes after Stranger Things were left raging after Netflix issued an update on the hit series' newest instalment that's sure to disappoint fans in the UK. <br>
                        <br>The sci-fi series returned to screens earlier this month for its fifth and final series, which is being released across three drops to the streaming site.</p>
                </section>
                </div>
                ...
                $comments = [
                    [
                        'name' => 'Americancool',
                        'location' => 'Boca, United States',
                        'time' => 'moments ago',
                        'text' => "Robin's character was repulsive in this new season. Why was she given so many lines...she's obnoxious and was not part of the original team. Good riddance.",
                        'up' => 0,
                        'down' => 0,
                    ],
                    [
                        ...
                        'time' => '39 minutes ago',
                        'text' => "If it meant the end of the narcissistic, self-entitled, gaslighting, nauseating. Millie Bobby Brown's (if that's her stage name this week) career, I would be thrilled",
                        'up' => 3,
                        'down' => 2,
                    ],
                    [
                        ...
                        'time' => '44 minutes ago',
                        'text' => "Yeah I'm ok with that. She was just the Nepo baby given more screen time than the actual main characters.",
                        'up' => 1,
                        'down' => 2,
                    ],
                ];
                $comment_count = 15; // total count for the 'Show more' button
                ?>
