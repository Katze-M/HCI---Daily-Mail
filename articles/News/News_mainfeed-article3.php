    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/news_article_pics/News-9.avif" alt="Trump interview" class="w-full rounded-lg object-cover" style="height:360px;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Husband is charged with murdering Miss Switzerland finalist mother-of-two who was 'strangled, "pureed" in a blender and had womb cut out'</h1>
                ...
                <div class="my-4 border-t border-b border-blue-300 py-2">
                    ...
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 09:40 GMT, 10 December 2025 | Updated: 10:02 GMT, 10 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">A husband has been charged with brutally murdering his Miss Switzerland finalist wife after he allegedly strangled her and pureed her body parts in a blender. 
                ...
                <p class="text-gray-700 leading-relaxed">Some of his wife's body parts were said to have then been forced into a powerful industrial blender, in which he allegedly 'pureed' them, as well as dissolving some in a chemical solution.
                ...
                <figure class="mt-6">
                    <img src="/assets/news_article_pics/News-10.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>The 41-year-old, who was named in local media by the pseudonym of Thomas due to Swiss privacy laws, is accused of decapitating Kristina Joksimovic and cutting out her womb </b></figcaption>
                </figure>
                <figure class="mt-6">
                    <img src="/assets/news_article_pics/News-11.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Model Kristina was found dead in her home in Binningen, near Basel, Switzerland, in February 2024, with an autopsy revealing that she was strangled before being dismembered in the laundry room with a jigsaw, knife and garden shears</b></figcaption>
                </figure>
                <figure class="mt-6">
                    <img src="/assets/news_article_pics/News-12.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>The model's husband admitted to having killed his wife, claiming self defence, per local media</b></figcaption>
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">The autopsy found that Joksimovic's cause of death was strangulation, with her neck showing a 'reddish throttle mark'.
                ...
                <figure class="mt-6">
                    <img src="/assets/news_article_pics/News-13.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Kristina, the mother of their two children, was allegedly killed because she had previously threatened her husband with a knife</b></figcaption>
                </figure>
                <figure class="mt-6">
                    <img src="/assets/news_article_pics/News-14.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Kristina and her husband have two daughters (pictured above during a beach holiday in August 2023)</b></figcaption>
                </figure>
