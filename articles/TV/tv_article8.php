    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/tv_assets/article8-img1.png" alt="Antiques Roadshow corkscrew" class="w-full rounded-lg object-cover" style="height:360px;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Antiques Roadshow expert captivated by 'stunning' kitchen tool with 'special' backstory - and owner can't stop smiling when she finds out its huge value</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By EMMA GUINNESS</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 08:59 GMT, 9 December 2025 | Updated: 09:00 GMT, 9 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">An expert on Sunday's episode of the Antiques Roadshow was blown away by a 'stunning' kitchen utensil made from the Old London Bridge.</p>

                <p class="text-gray-700 leading-relaxed mt-4">The humble corkscrew came with an incredible backstory after it was fashioned from wood used to build the Old London Bridge, which was destroyed way back in 1831.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Standing for a staggering 600 years, the medieval stone bridge contained several houses, shops and even a church.</p>

                <p class="text-gray-700 leading-relaxed mt-4">The guest revealed: 'My husband Charles got it about 10 years ago and it's made from Old London Bridge.'</p>

                <p class="text-gray-700 leading-relaxed mt-4">Blown away by the piece, antiques expert John Foster said: 'It's pretty special, isn't it?'</p>

                <figure class="mt-6">
                    <img src="/assets/tv_assets/article8-img2.png" alt="Corkscrew close-up" class="w-full rounded-lg object-cover" />
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">'The plaque there, in tiny writing, it says "Made from the oak 656 years under old London Bridge, put down in 1176."'</p>

                <p class="text-gray-700 leading-relaxed mt-4">The item's historical provenance did not stop there and the expert pointed out that even more could be learned from the corkscrew's iron.</p>

                <p class="text-gray-700 leading-relaxed mt-4">He added: 'Then it gets better, because the iron, all the way round when you look at it is inscribed "Taken from the pile that was 656 years in the foundations of old London Bridge".'</p>

                <figure class="mt-6">
                    <img src="/assets/tv_assets/article8-img3.png" alt="Cucumber cutter" class="w-full rounded-lg object-cover" />
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">Describing the corkscrew as 'stunning', John revealed that it would fetch more than a pretty penny if it were to be sold at auction.</p>

                <p class="text-gray-700 leading-relaxed mt-4">He said: 'I think it's stunning. At auction I think that it would easily make two to three thousand pounds. If you want one of this type, this is it.'</p>

                <p class="text-gray-700 leading-relaxed mt-4">The corkscrew was not the only interesting item to feature on the kitchen utensils episode of the show and a very unusual cucumber cutter was also valued.</p>

                <p class="text-gray-700 leading-relaxed mt-4">The guest explained that her parents had commissioned the cucumber cutter as they wanted a unique addition to their collection in honour of their silver wedding anniversary.</p>

                <?php
                // Sample comments for this article (client-side append will emulate the rest)
                $comments = [
                    ['name'=>'AntiqueFan','location'=>'Bath','time'=>'2 hours ago','text'=>'What a lovely find — incredible provenance.','up'=>6,'down'=>0],
                    ['name'=>'MuseumGuy','location'=>'London','time'=>'4 hours ago','text'=>'Made from Old London Bridge — you don\'t see that every day.','up'=>4,'down'=>0],
                ];
                $comment_count = 13;
                ?>
