    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/tv_assets/article6-img1.png" alt="Binky Felstead" class="w-full rounded-lg object-cover" style="height:360px; object-position:50% 25%;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Binky Felstead reveals what she eats in a day and how she trains to maintain her strong gym-honed figure while juggling parenting three children</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By BETHAN EDWARDS, SHOWBUSINESS REPORTER</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 10:17 GMT, 5 December 2025 | Updated: 10:33 GMT, 5 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">She regularly showcases her washboard abs and jaw-dropping figure in sizzling bikini Instagram snaps - championing the importance of strength over size. And Binky Felstead has now revealed exactly what she eats in a day and how she trains to maintain her strong gym-honed figure while juggling parenting three children.</p>

                <p class="text-gray-700 leading-relaxed mt-4">The TV personality, 35, told Daily Mail that she got the 'gym bug' after welcoming her first child India, in 2017 and now works out 'four or five times a week'. Binky explained that she has set up a home gym so she can enjoy a quick '45minute hit session, run or spin to set herself up for the rest of the day'.</p>

                <figure class="mt-6">
                    <img src="/assets/tv_assets/article6-img2.png" alt="Binky training" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2">Binky Felstead training at home</figcaption>
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">Detailing her workouts, she added: 'I think once you've got that fitness bug, which I kept hearing about, you don't really ever lose it. It just makes me feel really good. I love getting up in the morning, doing a 45 minute hit or run or spin and it sets me up for the rest of the day.'</p>

                <p class="text-gray-700 leading-relaxed mt-4">Binky explained that she isn't strict with her diet but has become 'more wary' as she gets older and focuses on having balance and control with her meals. She also discussed her children's allergy and how they manage it with careful microdosing and medical supervision.</p>

                <figure class="mt-6">
                    <img src="/assets/tv_assets/article6-img3.png" alt="Binky family" class="w-full rounded-lg object-cover" />
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">As well as daughter India, Binky shares two sons Wolfie, four, and Wilder, two, with husband Max Darnton. She described the challenges and the importance of knowledge when dealing with severe allergies and praised NHS staff for their help during emergencies.</p>

                <figure class="mt-6">
                    <img src="/assets/tv_assets/article6-img4.png" alt="Binky with children" class="w-full rounded-lg object-cover" />
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">The influencer emphasised that knowledge is power when it comes to allergies and advised parents to consult their GP and always carry an adrenaline device where appropriate.</p>

                <figure class="mt-6">
                    <img src="/assets/tv_assets/article6-img5.png" alt="Binky lifestyle" class="w-full rounded-lg object-cover" />
                </figure>

                <?php
                // Sample comments for this article
                $comments = [
                    ['name'=>'ReaderA','location'=>'Manchester','time'=>'3 hours ago','text'=>'Excellent tips — love her balance approach.','up'=>12,'down'=>0],
                    ['name'=>'GymFan','location'=>'Leeds','time'=>'5 hours ago','text'=>'Great to hear about practical workouts for busy parents.','up'=>8,'down'=>1],
                ];
                $comment_count = 105;
                ?>
                ...
                <section id="comments-section" class="mt-6 bg-white rounded shadow p-4">
                    ...
                    (function(){
                        document.addEventListener('DOMContentLoaded', function(){
                            ...
                            // Delegated reply handling (robust)
                            ...
                            // Delegated fallback for reply-submit buttons
                            commentsEl.addEventListener('click', function(e){
