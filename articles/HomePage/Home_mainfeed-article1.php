    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/HomePage_assets/Homepage_article1-image1.png" alt="Worker fired after arriving early" class="w-full rounded-lg object-cover" style="height:360px;" />
                    
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Worker is fired from her job after boss was fed up with her arriving 40 minutes EARLY all the time</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By OLIVIA ALLHUSEN, FOREIGN NEWS REPORTER</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 10:40 GMT, 9 December 2025 | Updated: 14:52 GMT, 9 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">A Spanish office worker has been fired for a habit most bosses would normally celebrate - turning up far too early.</p>

                <p class="text-gray-700 leading-relaxed">The 22-year-old employee had been warned repeatedly since 2023 to stop arriving between 6.45am and 7am, a full 40 minutes before her shift was due to start.</p>

                <p class="text-gray-700 leading-relaxed">But despite being told she wasn't allowed to clock in or begin work ahead of her 7.30am start time, she kept showing up at dawn with nothing to do.</p>

                <p class="text-gray-700 leading-relaxed">Her boss eventually lost patience and fired her for serious misconduct, arguing that her relentless early-bird routine meant she wasn't actually contributing to the company - only ignoring instructions.</p>

                <div class="mt-4">
                    <img src="/assets/HomePage_assets/Homepage_article1-image2.png" alt="Office building" class="w-full h-auto object-contain rounded-lg shadow" />
                </div>

                <p class="text-gray-700 leading-relaxed">The woman appealed to the Social Court of Alicante, insisting the dismissal was unjustified. But judges heard she had ploughed on with her routine even after multiple verbal and written warnings, racking up 19 more early arrivals.</p>

                <p class="text-gray-700 leading-relaxed">On some days, she even tried to log in through the company app before she'd reached the office. Her employer also accused her of a separate breach of trust - selling a used company car battery without permission - which the court said added to the pattern of disloyalty.</p>

                <p class="text-gray-700 leading-relaxed">In its ruling, the court backed the company, stressing that the issue wasn't her 'excessive punctuality' but her stubborn refusal to obey workplace rules - a serious breach under Article 54 of the Spanish Workers' Statute.</p>

                <p class="text-gray-700 leading-relaxed">The case has sparked a lively debate on social media, where many were baffled that turning up early could get someone fired. Employment experts, however, note that firms are entitled to enforce strict access rules once they have been made clear.</p>

                <p class="text-gray-700 leading-relaxed">The woman may still appeal to the Supreme Court of Valencia, but for now the judgement stands.</p>

                <p class="text-gray-700 leading-relaxed">It comes after earlier this year a woman revealed she got fired from her new job before even starting... and the reason why sparked a fierce debate online. The woman, named Alice, from Florida, took to Reddit under the subreddit called Jobs to share her disappointment after she was let go from her workplace ahead of her first day.</p>

                <?php
                // Sample comments extracted/created from article discussion
                $comments = [
                    [
                        'name' => 'SkepticSam',
                        'location' => 'Madrid, Spain',
                        'time' => '2 hours ago',
                        'text' => "Showing up early is laudable — but if rules forbid logging in early, following instructions matters.",
                        'up' => 12,
                        'down' => 3,
                    ],
                    [
                        ...
                        'time' => '1 hour ago',
                        'text' => "If she wasn't allowed to clock in then she shouldn't have been in the building. It's about following rules.",
                        'up' => 8,
                        'down' => 2,
                    ],
                    [
                        ...
                        'location' => 'Online',
                        'time' => 'Just now',
                        'text' => "This will be an interesting case if it reaches the Supreme Court of Valencia.",
                        'up' => 3,
                        'down' => 0,
                    ],
                ];
