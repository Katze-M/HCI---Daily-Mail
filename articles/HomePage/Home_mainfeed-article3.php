    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/HomePage_assets/Homepage_article3-image1.png" alt="Melania visits hospital" class="w-full rounded-lg object-cover" style="height:360px;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Melania Trump slammed over 'really bizarre' faux pas while reading Christmas story to kids during hospital visit</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By CYDNEY YEATES, US SENIOR TV WRITER</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 16:48 GMT, 9 December 2025 | Updated: 16:59 GMT, 9 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">Melania Trump has been ripped apart after she read to a group of young children without showing them any of the pictures.</p>

                <p class="text-gray-700 leading-relaxed">The First Lady, 55, made an appearance at Children's National Hospital in Washington, D.C., last week where she attempted to bring some festive cheer with a story session. During the visit, a group of kids gathered around and Melania sat down to read How Does Santa Go Down the Chimney?</p>

                <p class="text-gray-700 leading-relaxed">As she turned the pages, however, she didn't invite her audience to steal a glimpse at the accompanying illustrations. Clips of Melania's visit have since gone viral with social media users fiercely criticizing her for not properly engaging with her young audience by showing them the images inside the book.</p>

                <figure class="mt-6">
                    <img src="/assets/HomePage_assets/Homepage_article3-image2.png" alt="Melania giving gifts" class="w-full rounded-lg object-cover" />
                </figure>

                <p class="text-gray-700 leading-relaxed">When Melania wrapped up her Christmas story, she made sure Hinkle, a current hospital patient, had a proper greeting with Santa Claus and Mrs. Claus, who were standing nearby. After talking to other young patients, the First Lady tried to leave, but not without giving Hinkle a hug. She also came bearing gifts, including 'Be Best' ornaments, to give out to the patients.</p>
