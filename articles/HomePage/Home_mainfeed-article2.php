...
$comments = [
    ['name' => 'Jane D', 'text' => 'This interview will stir debate.', 'time' => '2h'],
    ['name' => 'Reader123', 'text' => 'Hard to see easy answers here.', 'time' => '1h'],
];
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/HomePage_assets/Homepage_article2-image1.png" alt="Trump interview" class="w-full rounded-lg object-cover" style="height:360px;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Trump explodes at Zelensky for not accepting peace deal as he warns Putin 'has the upper hand'</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By ROSS IBBETSON, ASSOCIATE EDITOR</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 13:00 GMT, 9 December 2025 | Updated: 14:58 GMT, 9 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">The President said that the Ukrainian leader needs to 'get his act together and start accepting things.'</p>

                <p class="text-gray-700 leading-relaxed">Trump also issued withering criticism for America's 'weak' European allies, accusing them of 'talking too much' while 'not delivering' peace for the Ukrainian people.</p>

                <p class="text-gray-700 leading-relaxed">When pressed on whether Kyiv or Moscow holds greater leverage at the negotiating table, Trump was unequivocal: 'There can be no doubt about that. It's Russia. It's a much bigger country.'</p>

                <figure class="mt-6">
                    <img src="/assets/HomePage_assets/Homepage_article2-image2.png" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2">Diplomatic talks continue in Europe.</figcaption>
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">It comes as Ukraine is set to present a revised 20-point peace plan to the US. Kyiv is under pressure from the White House to agree swiftly to a peace settlement, while trying to counterbalance a US-backed draft proposal that has been widely criticised for favouring Moscow.</p>

                <figure class="mt-6">
                    <img src="/assets/HomePage_assets/Homepage_article2-image3.png" alt="Summit" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2">World leaders at a hastily convened summit.</figcaption>
                </figure>
