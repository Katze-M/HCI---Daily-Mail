        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4" style="overflow:hidden; border-radius:8px;">
                    <img src="/assets/US_assets/article2-img1.png" alt="Media laws" class="w-full rounded-lg object-cover" style="height:300px; object-position:50% 22%;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Media laws to stay despite US tech giant threat</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By AUSTRALIAN ASSOCIATED PRESS</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 04:09 GMT, 21 March 2025 | Updated: 04:09 GMT, 21 March 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">Laws targeting social media companies in Australia will remain in place despite US tech giants pressuring President Donald Trump to take retaliatory action.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Moves by the federal government to force social media companies to pay media organisations for content on their platforms have prompted calls for Australia to be targeted.</p>

                <p class="text-gray-700 leading-relaxed mt-4">A formal complaint was lodged by the Computer and Communications Industry Association in the US, calling the laws "coercive and discriminatory".</p>

                <p class="text-gray-700 leading-relaxed mt-4">But a federal government spokesman said the media laws would be unchanged.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"The Albanese government will always stand up for Australian media and Australian journalism. It matters. We respect it. We will fight to protect it," the spokesman said.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"It is designed to encourage big digital platforms to continue to enter into commercial deals with news media organisations."</p>

                <p class="text-gray-700 leading-relaxed mt-4">Among those represented by the US communications peak body is X, owned by Elon Musk, who is a key figure in the Trump administration.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Mr Musk had previously called the Australian government "fascists" over efforts to crack down on misinformation on social media.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Treasurer Jim Chalmers said the reaction from the US companies was predictable.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"It's not surprising that the tech giants would have that view," he told Sky News on Friday.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"Our job is to make decisions in Australia's national interest, to protect kids online, for example, or to make sure that there's a level playing field in our media with our media organisations."</p>

                <p class="text-gray-700 leading-relaxed mt-4">"It's self evident that (tech billionaires) are very close with the US administration. Our focus and our job is to make our case in the US, as we have been doing," he said.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Greens senator Sarah Hanson-Young said Australians would not be bullied by tech billionaires in the US.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"As a sovereign and independent country, Australia has the right to make laws that represent our values as a fair society and protect our citizens online," she said.</p>

                <p class="text-gray-700 leading-relaxed mt-4">The calls coincide with Australia being slapped with 25 per cent tariffs on steel and aluminium exports by the Trump administration.</p>

                <p class="text-gray-700 leading-relaxed mt-4">There are fears further trade measures will soon be applied to other Australian products such as pharmaceuticals and beef, some of the largest exports to the US.</p>

                <p class="text-gray-700 leading-relaxed mt-4">National Farmers' Federation president David Jochinke said the peak body had been in regular contact with US counterparts to argue against tariffs being imposed on agricultural goods.</p>

                <p class="text-gray-700 leading-relaxed mt-4">He said it was better for both Australia and the US if the measures were not put in place.</p>

                <?php
                // Seed a couple of visible comments; total shown below
                $comments = [
                    ['name'=>'AussieReader','location'=>'Sydney','time'=>'3 hours ago','text'=>'Important to protect local journalism.','up'=>8,'down'=>0],
                    ['name'=>'TechWatcher','location'=>'Melbourne','time'=>'5 hours ago','text'=>'These laws will have wide implications for platforms.','up'=>5,'down'=>1],
                ];
                $comment_count = 61;
                ?>
