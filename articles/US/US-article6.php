        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4" style="overflow:hidden; border-radius:8px;">
                    <img src="/assets/US_assets/article6-img1.png" alt="Offset mortgage" class="w-full rounded-lg object-cover" style="height:320px; object-position:50% 28%;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">We still owe £300,000, can an offset mortgage save us money? DAVID HOLLINGWORTH replies</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By DAVID HOLLINGWORTH FOR THIS IS MONEY | Updated: 15:45 GMT, 25 February 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">We are about to come to the end of our 1.4 per cent five-year fixed rate mortgage and are preparing for our monthly payments to jump.</p>

                <p class="text-gray-700 leading-relaxed mt-4">In the past we had an offset mortgage and this helped us beat low savings rates but when we moved home we switched to a standard mortgage.</p>

                <p class="text-gray-700 leading-relaxed mt-4">I am now wondering if it is worth going back to an offset mortgage.</p>

                <p class="text-gray-700 leading-relaxed mt-4">We have a £300,000 repayment mortgage on an £800,000 home, with 15 years left on the term.</p>

                <p class="text-gray-700 leading-relaxed mt-4">We have about £30,000 in joint personal savings and my wife is a sole trader, so keeps between £20,000 and £40,000 in an account to pay herself when she needs money and cover her tax bills when they come.</p>

                <p class="text-gray-700 leading-relaxed mt-4">When I have looked around, there don't seem to be many offset mortgages on offer though and rates seem higher. Is it worth getting one?</p>

                <h2 class="text-xl font-semibold mt-6">David Hollingworth replies</h2>

                <p class="text-gray-700 leading-relaxed mt-2">You won't be alone in being one of the borrowers only just coming to the end of a fixed rate with a very low interest rate.</p>

                <p class="text-gray-700 leading-relaxed mt-2">It can seem hard to believe that it was only December 2021 when base rate was first increased from its record low of 0.10 per cent to 0.25 per cent. What followed was a series of rate increases taking base rate to 5.25 per cent in August 2023.</p>

                <p class="text-gray-700 leading-relaxed mt-2">The sheer pace of change has already seen many borrowers come to the end of their deal and switch in a market that looks very different to the ultra-low mortgage rates that were commonplace.</p>

                <p class="text-gray-700 leading-relaxed mt-2">On the more positive side fixed rates have improved from the peak levels reached during periods of significant volatility. The outlook has eased but although some fixed rates have just edged back below 4 per cent your payments will still rise substantially.</p>

                <p class="text-gray-700 leading-relaxed mt-2">A £300,000 mortgage over 15 years at say 4.25 per cent will cost £2,257 a month, whereas the same mortgage at 1.40 per cent would be more than £400 a month lower at £1,849.</p>

                <p class="text-gray-700 leading-relaxed mt-2">It's clearly important that you take advice and conduct a thorough search of the market for the best deal to help mitigate that rise. That search should include revisiting whether an offset mortgage could be a useful tool to help you manage and reduce the overall cost of your mortgage.</p>

                <h3 class="text-lg font-semibold mt-4">How does an offset mortgage work?</h3>

                <p class="text-gray-700 leading-relaxed mt-2">Offset mortgages link a separate savings account to the mortgage. Instead of paying interest on the savings, the lender only charges interest on the difference between the mortgage and savings balances.</p>

                <p class="text-gray-700 leading-relaxed mt-2">For example, a borrower with a £100,000 mortgage and £20,000 in savings would only be charged interest on £80,000.</p>

                <p class="text-gray-700 leading-relaxed mt-2">Many offset deals will allow a choice of how to apply the benefit of the offset account. By maintaining the normal mortgage payment there will be an overpayment made that will help gradually erode the mortgage balance and total interest payable.</p>

                <p class="text-gray-700 leading-relaxed mt-2">That could ultimately see the mortgage repaid early and save thousands in interest over the life of the mortgage. Alternatively, the impact of the savings could reduce the required monthly mortgage payment. The mortgage won't be paid back early but it will reduce the monthly cost.</p>

                <p class="text-gray-700 leading-relaxed mt-2">Looking at it from the savings side, the effective return on the cash is at the mortgage rate and there's no income tax liability, as no interest is earned. If there would otherwise be tax to pay on savings, then you'd need an even higher savings rate to get the same effective rate.</p>

                <p class="text-gray-700 leading-relaxed mt-2">One of the big practical benefits of offset compared to overpaying is that the cash remains easily accessible. This will be important for your wife who clearly needs to be able to have instant access to the funds.</p>

                <div class="my-4" style="overflow:hidden; border-radius:6px;"><img src="/assets/US_assets/article6-img2.png" alt="Couple discussing mortgage" class="w-full object-cover" style="height:260px; object-position:50% 30%;"/></div>
                ...
                <?php
                $comments = [
                    ['name'=>'Reader1','location'=>'London','time'=>'1 day ago','text'=>'Useful clear explanation, thank you.','up'=>3,'down'=>0],
                ];
                $comment_count = 19;
                ?>
