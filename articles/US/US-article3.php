        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4" style="overflow:hidden; border-radius:8px;">
                    <img src="/assets/US_assets/article3-img1.png" alt="Treasury shock admission" class="w-full rounded-lg object-cover" style="height:360px; object-position:50% 22%;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Trump's Treasury chief's shock admission about the economy ... and why it might be worth it</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By ROB CRILLY, US CHIEF POLITICAL CORRESPONDENT</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 16:17 GMT, 7 March 2025 | Updated: 13:10 GMT, 9 March 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">Treasury Secretary Scott Bessent on Friday said that the American economy may slow during a 'detox period' as the Trump administration slashes public spending.</p>

                <p class="text-gray-700 leading-relaxed mt-4">But he said it would be short-lived as private money filled the gap left by government cash.</p>

                <p class="text-gray-700 leading-relaxed mt-4">It comes amid a string of indicators warning of turbulence ahead and after President Donald Trump admitted on Tuesday that his plans for tariffs would trigger market uncertainty.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"Could we be seeing this economy, that we inherited, roll a bit? Sure," said Bessent on CNBC's Squawk Box.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"Look, there's going to be a natural adjustment as we move away from public spending to private spending.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"The market and the economy have just become hooked, and we've become addicted to this government spending, and there's going to be a detox period."</p>

                <p class="text-gray-700 leading-relaxed mt-4">The Trump administration has moved quickly to end what it claims is waste and fraud in federal spending.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Fuelled by Elon Musk's drive at the Department of Government Efficiency, it has laid off thousands of workers, canceled contracts, and shuttered USAID.</p>

                <p class="text-gray-700 leading-relaxed mt-4">But that means choking off billions of dollars that would have flowed from government coffers into the wider economy.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Bessent said the cuts would go hand in hand with deregulation, making it easier for the private sector to compensate.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"We are going to have safe and sound regulation to get our banking system going again," he said.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"So the banks should be generating loans to private companies. Employment should be from private companies, not from government, and I'm confident, if we have the right policies, it'll be a very smooth transition."</p>

                <p class="text-gray-700 leading-relaxed mt-4">He spoke shortly before the latest job figures were published. It showed a slight uptick in payroll numbers in February, although the overall unemployment rate moved from up a tenth of one percent to 4.1 percent.</p>

                <p class="text-gray-700 leading-relaxed mt-4">A day earlier, Bessent defended Trump's position on tariffs, which has put markets on edge amid warnings it will push up prices for consumers.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"Access to cheap goods is not the essence of the American dream," he said in a speech to Economic Club of New York.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"The American Dream is rooted in the concept that any citizen can achieve prosperity, upward mobility, and economic security.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"For too long, the designers of multilateral trade deals have lost sight of this."</p>

                <p class="text-gray-700 leading-relaxed mt-4">Economists are not the only ones who have admitted tariffs could cause problems.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Trump admitted they could bring market turbulence during his address to Congress on Tuesday night.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"Tariffs are about making America rich again and making America great again. And it’s happening, and it will happen rather quickly," he said.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"There will be a little disturbance, but we’re OK with that. It won’t be much."</p>

                <p class="text-gray-700 leading-relaxed mt-4">He spoke after markets had fallen for the second day running, as economists worry that his back and forth with allies over tariffs is causing uncertainty and amid wider fears that they will push up prices.</p>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    <img src="/assets/US_assets/article3-img2.png" alt="Chart" class="w-full rounded object-cover" style="height:220px; object-position:50% 20%;" />
                    <img src="/assets/US_assets/article3-img3.png" alt="Protest" class="w-full rounded object-cover" style="height:220px; object-position:50% 20%;" />
                </div>

                <?php
                $comments = [
                    ['name'=>'MarketFan','location'=>'NY','time'=>'2 hours ago','text'=>'Tough medicine but necessary.','up'=>23,'down'=>2],
                    ['name'=>'ConcernedCitizen','location'=>'Ohio','time'=>'5 hours ago','text'=>'Worried about short-term pain for many families.','up'=>12,'down'=>4],
                ];
                $comment_count = 117;
                ?>
