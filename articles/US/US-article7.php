        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4" style="overflow:hidden; border-radius:8px;">
                    <img src="/assets/US_assets/article7-img1.png" alt="US business groups dismay at tariffs" class="w-full rounded-lg object-cover" style="height:320px; object-position:50% 22%;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">US business groups voice dismay at Trump's new tariffs</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By AFP | Published: 00:14 GMT, 3 April 2025 | Updated: 00:14 GMT, 3 April 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">President Donald Trump's sweeping tariff announcement on Wednesday was widely panned by US business lobbying groups, who voiced concern about the impact of the new duties on their operations.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Standing on the White House lawn, Trump unveiled a baseline 10 percent tariff against almost all US trading partners in the world from April 5, and an additional top-up rate from April 9 for other countries currently imposing tariff and non-tariff barriers against US companies.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Trade groups reacted with dismay to the measures, which would see most goods imported from China, for example, facing an additional tariff totaling 34 percent on top of existing levies.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"Applying new tariffs at this scale will create change and disruption that restaurant operators will have to navigate to keep their restaurants open," the National Restaurant Association said in a statement.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"The stakes for manufacturers could not be higher," said Jay Timmons, the president of the National Association of Manufacturers. "Many manufacturers in the United States already operate with thin margins."</p>

                <p class="text-gray-700 leading-relaxed mt-4">"The high costs of new tariffs threaten investment, jobs, supply chains and, in turn, America's ability to outcompete other nations and lead as the preeminent manufacturing superpower," he added.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Alongside China, the European Union, India, and several other top US trading partners will also face new tariffs of at least 20 percent from April 9.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"These broad tariffs are a tax increase that will raise prices for American consumers and hurt the economy," US Chamber of Commerce chief policy officer Neil Bradley said in a statement before the tariffs were unveiled.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"We urge policymakers to instead focus efforts on accelerating the pro-growth agenda of extending our current tax policy, rebalancing regulations, and unleashing the full potential of American energy," he added.</p>

                <p class="text-gray-700 leading-relaxed mt-4">In a recent analysis, Yale University's Budget Lab estimated that a 20 percent across-the-board tariff on imports could cost the average US household at least $3,400 -- a painful cost-of-living adjustment for most Americans.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"President Trump's sweeping global and reciprocal tariffs are massive tax hikes on Americans that will drive inflation, kill jobs on Main Street, and may cause a recession for the US economy," Consumer Technology Association chief executive Gary Shapiro said in a statement.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"These tariffs will raise consumer prices and will force our trade partners to retaliate," he said.</p>

                <p class="text-gray-700 leading-relaxed mt-4">Despite the widespread condemnation, some lobbying groups were more positive about the announcement.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"Today's trade action prioritizes domestic manufacturers and America's workers," said Scott Paul, President of the Alliance for American Manufacturing.</p>

                <p class="text-gray-700 leading-relaxed mt-4">"These hardworking men and women have seen unfair trade cut the ground from beneath their feet for decades. They deserve a fighting chance," he said.</p>

                <?php
                $comments = [
                    ['name'=>'Analyst1','location'=>'DC','time'=>'3 hours ago','text'=>'This will be painful in the short term for many industries.','up'=>5,'down'=>0],
                ];
                $comment_count = 12;
                ?>
