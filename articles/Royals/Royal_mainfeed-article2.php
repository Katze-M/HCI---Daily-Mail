...
$comments = [
    [
        'name' => 'GraceL',
        'text' => 'Princess Diana’s influence clearly lives on through William. Amazing to see him continuing her legacy.',
        'time' => '2h'
    ],
    [
        'name' => 'UKCitizen92',
        'text' => 'Twenty years of dedication is impressive. Centrepoint has benefitted so much from his long-term support.',
        'time' => '1h'
    ],
];
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/Royal_assets/Royal-5.avif" alt="Trump interview" class="w-full rounded-lg object-cover" style="height:360px;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Prince William celebrates 20 years of his patronage with homeless charity Centrepoint - after Princess Diana took him to a shelter when he was 11 years old</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By REBECCA ENGLISH, ROYAL EDITOR and GINA KALSI, LIFESTYLE REPORTER</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 15:23 GMT, 9 December 2025 | Updated: 15:29 GMT, 9 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">Prince William cut a huge cake to mark 20 years as patron of youth homelessness charity Centrepoint today. 
                ...
                <p class="text-gray-700 leading-relaxed">He was presented with a specially commissioned chocolate cake created by Juliet Sear, the This Morning star and royal baker famed for making the towering confection featured in the Bruce Bogtrotter scene in Netflix's Matilda the Musical in 2022. 
                ...
                <p class="text-gray-700 leading-relaxed">It will likely have gone down a treat with the Prince of Wales, who is known to be a chocoholic and very fond of the treat, revealing in an engagement with Kate in May that 'I know my brownies'. 
                ...
                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-6.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>A young Prince William is pictured visiting the Centrepoint Hostel for Homeless in Soho, London in 1996 with his mother, Princess Diana </b></figcaption>
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">'The Centrepoint family is one I am very proud to be a part of and I can't thank you all [enough] for all the hard work, every day, you give to help other people.
                ...
                'I'm coming up to my third Christmas in the same property, so it has been amazing,' she told William.
                </p>

                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-7.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Prince William appeared in high spirits today as he marked his 20th anniversary as patron of homeless charity Centrepoint </b></figcaption>
                </figure>
