    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/Royal_assets/Royal-18.avif" alt="Article hero" class="w-full rounded-lg object-cover" style="height:360px;" />
                    
                </div>
                <h1 class="text-3xl font-bold text-blue-800 mb-2">Claudia Winkleman nods to Kate Middleton with chic MBE ceremony look - and we've hunted down her exact suit</h1>
                ...
                <div class="my-4 border-t border-b border-blue-300 py-2">
                    ...
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 15:55 GMT, 9 December 2025 | Updated: 07:12 GMT, 10 December 2025</div>
                </div>

                
                <p class="text-gray-700 leading-relaxed">
Claudia Winkleman lived up to her stylish reputation as she accepted an MBE from King Charles at Windsor Castle.

The Strictly Come Dancing host opted for a chic white trouser suit as she was honoured for her services to broadcasting, just weeks after her co-host Tess Daly received her own MBE.
<br><br>
Eagle-eyed fans may have recognised Claudia's sleek two-piece by The Kooples. She debuted the look, styled by Sinead McKeefry, at the 2024 Bafta Television Awards.

For her royal moment, Claudia refreshed the outfit by pairing the suit with a black shirt, white heels and a coordinating headband.

The look offered a nod to her royal relative, the Princess of Wales, who is known for her love of tailored trousers, with her white Alexander McQueen suit being a firm favourite. 

Meghan Markle has embraced the trend too, notably wearing a double-breasted Valentino blazer with wide-leg trousers at the 2022 Invictus Games.

With white trouser suits dominating the high street, you can easily emulate the trend yourself.

Shop Claudia's exact suit below or browse our edit to find your perfect match.
                </p>
                ...
                <div class="my-4 border-t border-blue-300 py-2">
                    ...
                    <div class="flex gap-4 my-6 p-4 border rounded-lg bg-white">
                        <img src="/assets/Royal_assets/Royal-19.avif" alt="Furbo 360 Dog Camera" class="w-32" style="width: 250px">
                        <div>
                            <h3 class="text-xl font-bold">Karen Millen Single Breasted Blazer </h3>                         
                            <p class="text-lg font-bold mt-3">£375 </p>
                    ...
                    <!-- Product 2 -->
                    <div class="flex gap-4 my-6 p-4 border rounded-lg bg-white">
                        <img src="/assets/Royal_assets/Royal-20.avif" alt="Furbo 360 Cat Camera" class="w-32" style="width: 250px">
                        <div>
                            <h3 class="text-xl font-bold">Karen Millen Straight Leg Trousers   </h3>                           
                            <p class="text-lg font-bold mt-3">£245 </p>
                            <button class="bg-orange-500 text-white px-4 py-2 rounded mt-2">Shop</button>
                        </div>
                    </div>
                    ...
                    <!-- Product 3 -->
                    <div class="flex gap-4 my-6 p-4 border rounded-lg bg-white">
                        <img src="/assets/Royal_assets/Royal-21.avif" alt="Furbo Mini" class="w-32" style="width: 250px">
                        <div>
                            <h3 class="text-xl font-bold">Nobody's Child Virgo Blazer </h3>                             
                            <p class="text-lg font-bold mt-3"> £111.20</p>
                            <button class="bg-orange-500 text-white px-4 py-2 rounded mt-2">Shop</button>
                        </div>
                    </div>
                    <!-- Product 4 -->
                    <div class="flex gap-4 my-6 p-4 border rounded-lg bg-white">
                        <img src="/assets/Royal_assets/Royal-22.avif" alt="Furbo Mini" class="w-32" style="width: 250px">
                        <div>
                            <h3 class="text-xl font-bold">Nobody's Child Viera Trousers  </h3>                                
                            <p class="text-lg font-bold mt-3">£48</p>
                            <button class="bg-orange-500 text-white px-4 py-2 rounded mt-2">Shop</button>
                        </div>
                    </div>
                </div>
                ...
                $comments = [
                    [
                        ...
                        'time' => 'Just now',
                        'text' => "Claudia’s outfit is absolutely gorgeous! A perfect blend of classy and modern—very Kate-inspired.",
                        'up' => 0,
                        'down' => 0,
                    ],
                    [
                        ...
                        'time' => '5 minutes ago',
                        'text' => "She pulled off the look so well. The suit is elegant without being over the top—totally MBE-worthy!",
                        'up' => 0,
                        'down' => 0,
                    ],
                    [
                        ...
                        'time' => '10 minutes ago',
                        'text' => "Loving the subtle nod to Kate’s style. Claudia always knows how to dress for the moment!",
                        'up' => 0,
                        'down' => 0,
                    ],
                ];
