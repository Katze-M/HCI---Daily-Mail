...
$comments = [
    [
        'name' => 'RoyalFollower',
        'text' => 'Good to see Harry focusing on charity work. Trusted aides can really help him make an impact.',
        'time' => '3h'
    ],
    [
        'name' => 'CharitySupporter',
        'text' => 'It’s always inspiring when royals dedicate themselves to charitable causes. Sentable is lucky to have his attention.',
        'time' => '2h'
    ],
];
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/Royal_assets/Royal-23.avif" alt="Trump interview" class="w-full rounded-lg object-cover" style="height:360px;" />
                </div>
                ...
                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By RICHARD EDEN, DIARY EDITOR</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 00:00 GMT, 1 April 2025 | Updated: 00:58 GMT, 1 April 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">Having felt the need to resign from his own charity, Sentebale, in an increasingly acrimonious row with its chairman, Prince Harry appears to be taking steps to shore up his influence on his only surviving good cause.
                ...
                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-24.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Prince Harry pictured at the closing ceremony of the Invictus Games at Rogers Arena in Vancouver, British Columbia, Canada, on February 16</b></figcaption>
                </figure>

                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-25.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>The Duke of Sussex and Board Chair Dr. Sophie Chandauka MBE attend a Sentebale reception and panel discussion at The Saxon Hotel in Johannesburg last October</b></figcaption>
                </figure>
