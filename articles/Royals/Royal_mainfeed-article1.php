...
$comments = [
    [
        'name' => 'HistoryBuff88',
        'text' => 'John Major’s involvement in the royal tensions is fascinating. His role as a mediator is often overlooked.',
        'time' => '3h'
    ],
    [
        'name' => 'RoyalWatcher',
        'text' => 'It’s interesting to see how political figures were drawn into the Charles and Diana situation at the time.',
        'time' => '1h'
    ],
];
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/Royal_assets/Royal-1.avif" alt="Trump interview" class="w-full rounded-lg object-cover" style="height:360px;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">How ex-PM John Major played the role of an 'honest broker' between Charles and Diana during the 'War of the Waleses'</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By RUTH STAINER, TRAINEE REPORTER</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 07:00 GMT, 9 December 2025 | Updated: 07:00 GMT, 9 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">On December 9, 1992, John Major stepped before the House of Commons and made a historic announcement that reverberated across the world. 

                'It is announced from Buckingham Palace that, with regret, the Prince and Princess of Wales have decided to separate,' the then-Prime Minister confirmed Charles and Diana's relationship had run its course. 
                </p><br>
                    Mr Major's statement marked the end of an incredibly tumultuous period for the Prince and Princess of Wales - dubbed 'The War of the Waleses' by the press due to their evident unhappiness in the years prior.
                <br>

                <p class="text-gray-700 leading-relaxed">It was appropriate for Mr Major, who served as Prime Minister from 1990 until 1997,  to make the announcement since he had played the important role of an 'honest broker' between the feuding royals before. 

                    Mr Major was also a 'sympathetic listener to Diana at a time when she felt her most alone', royal expert Valentine Low noted in his book Power and the Palace. 

                    Citing Mr Major's private secretary Alex Allan, the author noted how the politician, now 82, was 'quite concerned' about the Princess and gave Diana a 'shoulder to cry on' during the breakdown of her marriage. 

                </p><br>

                <p class="text-gray-700 leading-relaxed">Meanwhile, Diana's private secretary, Patrick Jephson, told Mr Low that the pair would meet regularly for tea, and Diana would humorously refer to Mr Major as 'the Hon. John'.

                'I got the very clear message that she enjoyed those meetings. He was an important, sympathetic, helpful mentoring figure. And he did it when he ceased to be prime minister as well,' Mr Jephson is quoted as saying. 
                </p>

                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-2.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Mr Major's public announcement marked the tragic end of what had been an incredibly tumultuous period for the Prince and Princess of Wales - with their bitter feud dubbed 'The War of the Waleses'</b></figcaption>
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">Princes William and Harry were 10 and eight respectively when news of their parents' separation was announced publicly.

                However, Mr Major had another very important reason for wanting to mitigate the fallout from Diana and Charles's separation, according to Lord Butler of Brockwell. 

                <br><br>

                He told Mr Low that while the Prime Minister 'would have been naturally sympathetic' towards Diana,  he could also foresee the damaging implications the Wales' separation could have for the sovereign and sought implicitly to 'protect the monarchy as an institution'.

                Certainly, there may also have been an innate feeling by the Royal Family that the empathetic and rational leader possessed the necessary capabilities to help resolve the crisis. 

                <br><br>

                During periods where things were said to have been 'really hairy' between Charles and Diana, Mr Jephson reportedly 'got the sense that Buckingham Palace had an "understandable wish" that Number 10 would sort things out'.

                'Ironically, the role of the monarchy is to act as the continuity, the unchanging face of the state, but I remember thinking it was us who were in a mess,' he told Mr Low. 
                </p>

                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-3.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Mr Major's private secretary, Alex Allan, told royal author Valentine Low that the now 82-year-old politician was 'quite concerned' about the princess and gave Diana a 'shoulder to cry on'</b></figcaption>
                </figure>

                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-4.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>The former Prime Minister had several sessions with the respective royals in the build-up to their separation, while also updating the late Queen Elizabeth II on the state of their marriage during their 'weekly audiences'</b></figcaption>
                </figure>
