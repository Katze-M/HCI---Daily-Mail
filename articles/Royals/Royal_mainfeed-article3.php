...
$comments = [
    [
        'name' => 'RoyalWatcher21',
        'text' => 'Lovely to see Lady Davina and Senna making a rare appearance. The family support for Kate is heartwarming.',
        'time' => '3h'
    ],
    [
        'name' => 'EmmaC_London',
        'text' => 'Such a beautiful event. It’s nice to see more of the extended royal family attending these special moments.',
        'time' => '1h'
    ],
];
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                <div class="mb-4">
                    <img src="/assets/Royal_assets/Royal-8.avif" alt="Trump interview" class="w-full rounded-lg object-cover" style="height:360px;" />
                </div>

                <h1 class="text-3xl font-bold text-blue-800 mb-2">Lady Davina Windsor and her daughter Senna support Kate Middleton at Christmas carol concert in rare royal outing</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By MAANYA SACHDEVA, ASSOCIATE EDITOR, ROYALS</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 07:08 GMT, 10 December 2025 | Updated: 08:15 GMT, 10 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">The last time that Lady Davina Windsor and her children, daughter Senna Kōwhai Lewis, 15, and son, Tane Mahuta, 13, made a public appearance was at the late Queen's state funeral in London on September 19, 2022. 

                The granddaughter of the Duke and Duchess of Gloucester, Senna was 12 when she was photographed holding Lady Davina's hand as she walked into Westminster Abbey along with senior members of the Firm. 

                Senna's demeanour couldn't have been more different as she smiled at the cameras outside Westminster Abbey last week. 
                                </p><br>
                ...
                <p class="text-gray-700 leading-relaxed">Senna picked a royal blue dress with a delicate black lace trim, and paired it with a velvet navy blazer as well as black stockings and ballet flats for an understated yet elegant festive look. 
                ...
                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-9.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>A rarely-seen royal family member stepped out of the shadows at Kate Middleton 's annual Christmas carol concert as fans couldn't believe her striking transformation. Pictured: The granddaughter of the Duke and Duchess of Gloucester </b></figcaption>
                </figure>

                <p class="text-gray-700 leading-relaxed mt-4">Born on June 22, 2010, Senna is the older child of Lady Davina and Māori carpenter and sheep-rearer Gary Lewis.
                ...
                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-10.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>The last time that Lady Davina Windsor's daughter Senna Kōwhai Lewis made a public appearance was at the late Queen's state funeral in London on September 19, 2022 </b></figcaption>
                </figure>
                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-11.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Lady Davina married Māori carpenter and sheep-rearer Gary Lewis in a low-key ceremony at Kensington Palace's private chapel in 2004 </b></figcaption>
                </figure>
