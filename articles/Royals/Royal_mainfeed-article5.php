    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                ...
                <h1 class="text-3xl font-bold text-blue-800 mb-2">Meghan Markle sends letter to her sick father Thomas in hospital after he made urgent plea he did not want to die with them being estranged</h1>

                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By MATT STRUDWICK, NEWS REPORTER</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 10:33 GMT, 10 December 2025 | Updated: 10:55 GMT, 10 December 2025</div>
                </div>

                <p class="text-gray-700 leading-relaxed">Meghan Markle has sent a letter to her sick father in hospital after he issued a plea to the Duchess - saying he did not want to die while they were estranged. 

The Duchess of Sussex, 44, sent the correspondence to Thomas Markle through 'reliable and trusted contacts' and it is said to now be 'safely' in his hands.

The 81-year-old is currently recovering in a hospital in the Philippines after undergoing a three-hour life-saving operation to remove his foot and lower leg.
</p><br>
Surgeons decided to amputate part of his left leg following the discovery of a large blood clot. 

Mr Markle had sent an urgent plea from his hospital bed to his daughter, saying: 'I don't want to die estranged.'

                <br>

                <p class="text-gray-700 leading-relaxed">He also said that he dreamed of seeing son-in-law Prince Harry and grandchildren Archie, six, and Lilibet, four, 'before it's too late'. 

Last Friday, the Duchess's spokesperson said she had 'reached out' to her father in an email. 

Unfortunately, the email address used is one he no longer uses or has access to.</p><br>


                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-16.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Meghan Markle's father Thomas Markle, 81, in his hospital bed in the Philippines following the amputation of his left leg below the knee. He has thanked the medical staff who saved his life</b></figcaption>
                </figure>

                <figure class="mt-6">
                    <img src="/assets/Royal_assets/Royal-17.avif" alt="Meeting" class="w-full rounded-lg object-cover" />
                    <figcaption class="text-sm text-gray-500 mt-2 my-4 border-t border-b border-black-300 py-2" ><b>Meghan Markle pictured with her father in 2011, whom she has been estranged from since 2018 after he posed for paparazzi pictures on the eve of her wedding</b></figcaption>
                </figure>
