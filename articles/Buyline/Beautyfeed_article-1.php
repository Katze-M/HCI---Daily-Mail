        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <main class="relative md:col-span-9 bg-white rounded shadow p-6">
                ...
                <div class="my-4 border-t border-b border-blue-300 py-2">
                    <div class="text-xl text-gray-600 mb-2 byline">By TANYA SHARMA, US COMMERCE WRITER</div>
                    <div class="text-xl text-gray-600 mb-0 byline">Published: 20:26 GMT, 5 December 2025 | Updated: 23:11 GMT, 7 December 2025</div>
                </div>

                
                <p class="text-gray-700 leading-relaxed">
                Luxurious beauty gifts are the ultimate treat, especially for the friend who has a wishlist miles long but who rarely spoils herself. Prestige products truly do feel special, kind of like unwrapping that MVP toy that you coveted during childhood.
                <br>
                <br>
                Now, though, she (or you!) may be all about Augustinus Bader, the cult-loved skincare brand behind the 'miracle in a bottle' that celebrities swear by for flawless complexions.
                <br>
                <br>
                ...
                <div class="my-4 border-t border-blue-300 py-2">
                    ...
                    <div class="flex gap-4 my-6 p-4 border rounded-lg bg-white">
                        <img src="/assets/Buyline_assets/MainFeed_SPic-1.avif" alt="Furbo 360 Dog Camera" class="w-32" style="width: 200px">
                        <div>
                    ...
                    <!-- Product 3 -->
                    <div class="flex gap-4 my-6 p-4 border rounded-lg bg-white">
                        <img src="/assets/Buyline_assets/MainFeed_SPic-3.avif" alt="Furbo Mini" class="w-32" style="width: 200px">
                        <div>
                            <h3 class="text-xl font-bold">Augustinus Bader x Sofia Coppola The Tinted Lip Balm  </h3>
                            <p class="text-gray-700 mt-2">
                                Sometimes you just want a pop of color — nothing more, nothing less. This beautiful balm created with Sofia Coppola is a must for every makeup collection, offering a hint of sheer color coupled with deep hydration.  The formula nourishes with shea butter, vitamin E and candelilla wax. 
                            </p> 
                            <p class="text-lg font-bold mt-3">£46</p>
                            <button class="bg-orange-500 text-white px-4 py-2 rounded mt-2">Shop</button>
                        </div>
                    </div>
                    <!-- Product 4 -->
