        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div class="md:col-span-7">
                ...
                <section class="mb-8">
                    ...
                    <div class="mt-4">
                        <h1 class="text-2xl font-semibold"><a href="articles/us_latest_article.php" class="text-blue-800 hover:underline">US tells Europe it must take over 'the majority' of NATO's defence capabilities by 2027 as Trump shifts American military focus while Putin's war in Ukraine rages...</a></h1>
