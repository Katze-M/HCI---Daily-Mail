<?php
    ...
    $personal_feed = [
        [
            'title' => "Cat Deeley just wore this fashionably festive jumper on This Morning - here's where you can buy it and three other Christmassy sweaters still available on the high street",
        ...
        [
            'title' => 'I’ve scoured the high street for the ultimate Christmas party dresses – these are my 27 favourites for under £100',
        ...
        [
            'title' => 'Gifting season is here! These are the presents our editors are hoping to receive under the tree this year',
    ...
    $main_feed = [
        [
            'title' => "Trump warns European nations are under threat of 'civilisational erasure' and will be 'unrecognisable' within the next 20 years",
        ...
        [
            'title' => 'Mysterious 400-mile stretch of radiation fog blankets 13 million Americans',
        ...
        [
            'title' => 'Family rage at cop for handcuffing teen after they failed to scan items at Walmart self checkout then walked out without paying',
    ...
    $category_strip = [
        [
            'title' => "The product I rely on for winter skin relief is discounted - and it's perfect for tackling bumpy, uneven texture",
            'comments' => 567,
            'shares' => 1500,
        ...
        [
            'title' => 'Celebrities swear by these skincare must-haves - and you can actually gift them without breaking the bank this Christmas',
            'comments' => 65,
            'shares' => 65,
        ...
        [
            'title' => 'Perricone MD drops rare deal on skincare-infused no make-up essentials - including liquid blush for a healthy flush',
            'comments' => 105,
            'shares' => 18,
                            ...
                            <div id="personal-feed-row" class="flex gap-4 overflow-x-auto py-2 px-8">
                                <?php foreach(array_slice($personal_feed,0,5) as $item): ?>
                                    <article class="max-w-[210px] flex-shrink-0 border rounded p-3 bg-gray-50">
                                        ...
                                        <p class="text-xs text-gray-600 mt-1 line-clamp-2 h-10"><?php echo $item['excerpt']; ?></p>
